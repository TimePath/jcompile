...
public fun Expression.plus(other: Expression): BinaryExpression.Add = BinaryExpression.Add(this, other, null)
public fun Expression.minus(other: Expression): BinaryExpression.Subtract = BinaryExpression.Subtract(this, other, null)
public fun Expression.times(other: Expression): BinaryExpression.Multiply = BinaryExpression.Multiply(this, other, null)
public fun Expression.div(other: Expression): BinaryExpression.Divide = BinaryExpression.Divide(this, other, null)
public fun Expression.mod(other: Expression): BinaryExpression.Modulo = BinaryExpression.Modulo(this, other, null)
