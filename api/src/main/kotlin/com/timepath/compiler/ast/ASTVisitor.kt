...
trait ASTVisitor<T> {
    ...
    fun visit(e: BinaryExpression.Add.Assign) = visit(e : BinaryExpression)
    ...
    fun visit(e: BinaryExpression.BitAnd.Assign) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.BitOr) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.BitOr.Assign) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.BitXor) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.BitXor.Assign) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Comma) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Divide) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Divide.Assign) = visit(e : BinaryExpression)
    ...
    fun visit(e: BinaryExpression.Lsh.Assign) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Lt) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Modulo) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Modulo.Assign) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Multiply) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Multiply.Assign) = visit(e : BinaryExpression)
    ...
    fun visit(e: BinaryExpression.Rsh.Assign) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Subtract) = visit(e : BinaryExpression)
    fun visit(e: BinaryExpression.Subtract.Assign) = visit(e : BinaryExpression)
